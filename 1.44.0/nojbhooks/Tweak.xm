...
{
    [esp setNeedsDisplay];
    if(me->object == instance)
    {
        me->id = *(int *)((uint64_t)instance + 0xAC);
    }
    ...
    if(instance)
    {
        ...
        if(me->object != instance && WorldToScreen(GetObjectLocation(instance)).z != 0 && me->position != GetObjectLocation(instance))
        {
        ...
        //ihpone
        //float enemyheightifelse = 4100;
        //float enemyweightifelse = 840;
...
void setup() {
    ...
    HOOK(local_update_ofset, new_local_update, old_local_update);
    HOOK(updatehookfset, new_player_update, old_player_update);
    HOOK(get_FovWorldofset, get_FovWorld, old_get_FovWorld);
    ...
    *(void **)&get_fieldOfView = (void *) getRealOffset(get_fieldOfViewofset);
    ...
    [switches addSwitch:NSSENCRYPT("Radar") description:nil];
    
    [switches addSliderSwitch4:NSSENCRYPT("Custom FOV")
      description:NSSENCRYPT("Set your custom move FOV")
      minimumValue:1
      maximumValue:200
    ...
    bool isOnRadar = [switches isSwitchOn:NSSENCRYPT("Radar")];
    if(isOnRadar) {
        ActiveCodePatch("Frameworks/UnityFramework.framework/UnityFramework", 0x19730A8, "C8008052");
    } else {
        DeactiveCodePatch("Frameworks/UnityFramework.framework/UnityFramework", 0x19730A8, "C8008052");
    }



    
    [switches addSwitch4:NSSENCRYPT("Auto reload") description:nil];
    [switches addSwitch4:NSSENCRYPT("Aim punch") description:nil];
    [switches addSwitch4:NSSENCRYPT("Movement not Allowed") description:nil];
    [switches addSwitch4:NSSENCRYPT("Shooting not Allowed") description:nil];
    [switches addSwitch3:NSSENCRYPT("Enemy Line") description:nil];
    [switches addSwitch3:NSSENCRYPT("Enemy Box") description:nil];
    [switches addSwitch3:NSSENCRYPT("Enemy Healthbar") description:nil];
    [switches addSwitch3:NSSENCRYPT("Enemy Bounds") description:nil];
    
    [switches addSwitch3:NSSENCRYPT("Friend Line") description:nil];
    [switches addSwitch3:NSSENCRYPT("Friend Box") description:nil];
    [switches addSwitch3:NSSENCRYPT("Friend Healthbar") description:nil];
    ...
    [switches addSwitch4:NSSENCRYPT("ThirdPerson View") description:nil];
    
    [switches addOffsetSwitch:NSSENCRYPT("Radar")
    description:NSSENCRYPT("Active Radar")
    offsets: {
      ENCRYPTOFFSET("0x1941500"),
    }
    bytes: {
  ...
  [switches addOffsetSwitch:NSSENCRYPT("Nick indicators")
    ...
    offsets: {
      ENCRYPTOFFSET("0x184ef60"),
      ENCRYPTOFFSET("0x184f69c"),
      ENCRYPTOFFSET("0x184c920")
    }
    bytes: {
  ...
  [switches addOffsetSwitch:NSSENCRYPT("no recoil")
    ...
    offsets: {
      ENCRYPTOFFSET("0x183d9e0"),
      ENCRYPTOFFSET("0x183d9d8"),
      ENCRYPTOFFSET("0x183C90C"),
    }
    bytes: {
   ...
   // Offset Switch with one patch
  [switches addOffsetSwitch:NSSENCRYPT("Aimssist")
    description:NSSENCRYPT("Aimassist")
    offsets: {
      ENCRYPTOFFSET("0x144D0D8"),
    }
    bytes: {
      ENCRYPTHEX("0x0010201EC0035FD6"),
    }
  ];

      // Offset Switch with one patch
  [switches addOffsetSwitch:NSSENCRYPT("Low rain")
    description:NSSENCRYPT("legit rain")
    offsets: {
      ENCRYPTOFFSET("0x14867cc"),
    }
    bytes: {
      ENCRYPTHEX("0x00102C1E"),
    }
  ];

      // Offset Switch with one patch
  [switches addOffsetSwitch2:NSSENCRYPT("Rage rain")
    description:NSSENCRYPT("One hit kill")
    offsets: {
      ENCRYPTOFFSET("0x14867d8"),
    }
    bytes: {
      ENCRYPTHEX("0x0090261E"),
    }
  ];

  
// Offset Switch with one patch
  [switches addOffsetSwitch:NSSENCRYPT("AimDown")
    description:NSSENCRYPT("aimdown")
    offsets: {
      ENCRYPTOFFSET("0x1943208"),
    }
    bytes: {
      ENCRYPTHEX("0x200080D2C0035FD6"),
    }
...
// Offset Switch with one patch
  [switches addOffsetSwitch2:NSSENCRYPT("Speed")
    description:NSSENCRYPT("speed")
    offsets: {
      ENCRYPTOFFSET("0x183cb58"),
    }
    bytes: {
      ENCRYPTHEX("0x0090261E"),
    }
       ...
       // Offset Switch with one patch
  [switches addOffsetSwitch:NSSENCRYPT("Always Crosshair")
    description:NSSENCRYPT("Always Crosshair")
    offsets: {
      ENCRYPTOFFSET("0x13ba378"),
    }
    bytes: {
      ENCRYPTHEX("0xC0035FD6"),
    }
     ...
     // Offset Switch with one patch
  [switches addOffsetSwitch:NSSENCRYPT("No granage")
    description:NSSENCRYPT("No granage hack")
    offsets: {
      ENCRYPTOFFSET("0x16adab8"),
    }
    bytes: {
      ENCRYPTHEX("0xC0035FD6"),
    }
  ...
  [switches addOffsetSwitch2:NSSENCRYPT("Wallbang")
    description:NSSENCRYPT("Wallbang hack")
    offsets: {
      ENCRYPTOFFSET("0x1487fc4")
    }
    bytes: {
  ...
  // Offset switch with multiple patches
  [switches addOffsetSwitch:NSSENCRYPT("Skip tutorial")
    description:NSSENCRYPT("skip tutorail")
    offsets: {
      ENCRYPTOFFSET("0x16ea408"),
      ENCRYPTOFFSET("0x16e97e8"),
      ENCRYPTOFFSET("0x16e93ec"),
      ENCRYPTOFFSET("0x16e9ed4"),
      ENCRYPTOFFSET("0x16e9ac4")
    }
    bytes: {
      ENCRYPTHEX("0x68018052"),
      ENCRYPTHEX("0x68018052"),
      ENCRYPTHEX("0x68018052"),
      ENCRYPTHEX("0x68018052"),
      ENCRYPTHEX("0x68018052")
    ...
    [switches addSwitch4:NSSENCRYPT("Watermark") description:nil];
