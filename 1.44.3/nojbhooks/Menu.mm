...
-(id)initWithTitle:(NSString *)title_ titleColor:(UIColor *)titleColor_ titleFont:(NSString *)titleFont_ credits:(NSString *)credits_ headerColor:(UIColor *)headerColor_ switchOffColor:(UIColor *)switchOffColor_ switchOnColor:(UIColor *)switchOnColor_ switchTitleFont:(NSString *)switchTitleFont_ switchTitleColor:(UIColor *)switchTitleColor_ infoButtonColor:(UIColor *)infoButtonColor_ maxVisibleSwitches:(int)maxVisibleSwitches_ menuWidth:(CGFloat )menuWidth_ menuIcon:(NSString *)menuIconBase64_ menuButton:(NSString *)menuButtonBase64_ {
    ...
    menuIcon.layer.cornerRadius = menuIcon.frame.size.width / 2;
...
[button2 addTarget:self 
 ...
 forControlEvents:UIControlEventTouchUpInside];
[button2 setTitle:@"Rage" forState:UIControlStateNormal];
...
[button4 addTarget:self 
 ...
 forControlEvents:UIControlEventTouchUpInside];
[button4 setTitle:@"Other" forState:UIControlStateNormal];
...
[self.scrollTab addSubview:button4];
    ...
    self.menuTitle = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, menuWidth_ - 0, 25)];
    ...
    self.footer = [[UIView alloc]initWithFrame:CGRectMake(0, CGRectGetHeight(self.bounds) - 1, menuWidth_, 25)];
    ...
    UILabel *footerLabelLeft = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, menuWidth_, 25)];
    footerLabelLeft.text = @"andrdev        Status: Undetect";
    ...
    UILabel *footerLabelRight = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, menuWidth_, 25)];
    footerLabelRight.text = @"1.44.0";
    ...
    tapGestureRecognizer2.numberOfTapsRequired = 3;
