...
#define monoArray saj89123
#define _monoString sdkja89231
/*
...
typedef struct _monoString
{
    ...
    bool operator==(_monoString *rhs) {
        if([this->toNSString() isEqualToString: rhs->toNSString()])
           return true;
        else
           return false;
      }
...
#define monoDictionary sdkl23109
...
#define monoDictionary2 sdaji21389
...
*/
#define GetObscuredIntValue sdoiaj21390092__000
...
*/
#define SetObscuredIntValue jsdadsaj_00
...
#define GetObscuredFloatValue sdsajd821389__67
...
*/
#define SetObscuredFloatValue sadksadk2130
...
*/
#define GetObscuredVector3Value sdakjlweiqo_tt_00
...
#define SetObscuredVector3Value sdaoisodai2132_00
