...
public struct Color
{
	...
	private readonly Int64 value; // 0x18
	private readonly Int16 knownColor; // 0x20
	private readonly Int16 state; // 0x22
...
{
	// Fields
	private float x; // 0x10
	private float y; // 0x14
